// India States + Union Territories with all districts
// Keys exactly match your <option> values in the state dropdown
...
const indiaDistricts = {
  ...
  Karnataka: [
    ...
    "Gadag","Gulbarga","Hassan","Haveri","Kodagu","Kolar","Koppal","Mandya","Mysore","Raichur",
  ...
  Ladakh: ["Kargil","Leh"],
  Lakshadweep: [
    "Agatti","Amini","Andrott","Bitra","Chetlat","Kadmat","Kalpeni","Kavaratti","Kilthan","Minicoy"
  ],
